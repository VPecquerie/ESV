 ...
 */
class LigneCommande extends \Croangels\ESV\EcommerceBundle\Entity\LigneCommande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\LigneCommande' . "\0" . 'id', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\LigneCommande' . "\0" . 'article', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\LigneCommande' . "\0" . 'quantite', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\LigneCommande' . "\0" . 'commande');
        }
