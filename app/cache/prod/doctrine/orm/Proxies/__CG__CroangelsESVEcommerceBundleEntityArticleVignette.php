 ...
 */
class ArticleVignette extends \Croangels\ESV\EcommerceBundle\Entity\ArticleVignette implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'id', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'url', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'alt', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'title', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'isMaster', '' . "\0" . 'Croangels\\ESV\\EcommerceBundle\\Entity\\ArticleVignette' . "\0" . 'article');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticleVignette $proxy) {
